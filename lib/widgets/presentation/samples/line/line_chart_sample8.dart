...
class _LineChartSample8State extends State<LineChartSample8> {
  List<Color> gradientColors = const [Color(0xffEEF3FE), Color(0xffEEF3FE)];
            ...
            children: <Widget>[
              AspectRatio(
                ...
                child: Padding(
                  ...
                  child: LineChart(mainData(imageSnapshot.data!)),
                ),
              ),
            ],
          );
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    const style = TextStyle(fontSize: 10, color: AppColors.mainTextColor1);
