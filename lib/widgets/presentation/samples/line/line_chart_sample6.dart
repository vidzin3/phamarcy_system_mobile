...
import 'package:phamarcy_system/widgets/util/extensions/color_extensions.dart';
...
class LineChartSample6 extends StatelessWidget {
  ...
  final spots = const [FlSpot(0, 1), FlSpot(2, 5), FlSpot(4, 3), FlSpot(6, 5)];

  final spots2 = const [FlSpot(0, 3), FlSpot(2, 1), FlSpot(4, 2), FlSpot(6, 1)];
        ...
        child: LineChart(
          LineChartData(
            ...
            lineBarsData: [
              ...
              LineChartBarData(
                gradient: LinearGradient(colors: [line2Color1, line2Color2]),
