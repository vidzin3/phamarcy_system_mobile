import 'package:phamarcy_system/widgets/presentation/samples/candlestick/candlestick_chart_sample1.dart';
...
class ChartSamples {
  static final Map<ChartType, List<ChartSample>> samples = {
    ...
    ChartType.radar: [RadarChartSample(1, (context) => RadarChartSample1())],
